...
OPEN_SSL_X86_64_DIR_PATH="${SOURCE_DIR}/${OPEN_SSL_x86_64_DIR_NAME}"
OPEN_SSL_ARM_DIR_PATH="${SOURCE_DIR}/${OPEN_SSL_ARM_DIR_NAME}"
...
build_openssl_install_common() {
	DIR=$1
	mv ${DIR}/include/* $BUILD_INCLUDE_DIR
	mv ${DIR}/libcrypto.a ${BUILD_LIB_DIR}/libcrypto.a
	mv ${DIR}/libssl.a ${BUILD_LIB_DIR}/libssl.a
}
...
build_openssl_install_universal() {
	OPEN_SSL_DIR_PATH="${SOURCE_DIR}/${OPEN_SSL_DIR_NAME}"
