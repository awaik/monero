...
build_boost_init_common() {
	...
	CFLAGS=$2
	LINKFLAGS=$3
	BOOST_SRC_DIR=${SOURCE_DIR}/boost_1_72_0
	BOOST_FILENAME=boost_1_72_0.tar.bz2
	BOOST_VERSION=1.72.0
	BOOST_FILE_PATH=${SOURCE_DIR}/${BOOST_FILENAME}
	...
	cd $SOURCE_DIR
	rm -rf $BOOST_SRC_DIR
	tar -xvf $BOOST_FILE_PATH -C $SOURCE_DIR
	cd $BOOST_SRC_DIR
...
build_boost_install_common() {
	...
	cp -r ${LIB_DIR}/*.a ${BUILD_LIB_DIR}
	cp -r boost ${BUILD_INCLUDE_DIR}
}
