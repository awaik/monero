...
mv ${OPEN_SSL_DIR_PATH}/include/* $BUILD_INCLUDE_DIR
mv ${OPEN_SSL_DIR_PATH}/lib/libcrypto-iOS.a ${BUILD_LIB_DIR}/libcrypto.a
mv ${OPEN_SSL_DIR_PATH}/lib/libssl-iOS.a ${BUILD_LIB_DIR}/libssl.a