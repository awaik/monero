...
## Build Android
build_scripts/android/prepare_system_and_build_all.sh
or
build_scripts/android/prepare_system.sh
or
build_scripts/android/build_monero_all.sh

## Build iOS
build_scripts/ios/build_monero_all.sh
build_scripts/ios/setup.sh
